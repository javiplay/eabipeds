...
public class BehaviorGene implements Gene, Cloneable {
	...
	public BehaviorGene(ArrayList<MotorActions> actions, int duration, float speed) {
	...
	public Object clone() {
		...
		return new BehaviorGene(clonedActions, getDuration(), getSpeed());
	}
