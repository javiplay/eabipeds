...
import org.geneura.javiplay.bipeds.simulators.ReactiveThreeLinksSimulator;
...
public class ReactiveThreeLinksTests {
	...
	public static void main(String[] args) {
		...
		ReactiveThreeLinksSimulator simulator = new ReactiveThreeLinksSimulator();
