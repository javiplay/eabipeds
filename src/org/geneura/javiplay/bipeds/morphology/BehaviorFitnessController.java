...
public class BehaviorFitnessController {
	...
	public BehaviorFitnessController(Individual ind, int cycles) {
	...
	public MotorActions getCurrentAction() {
		return ((BehaviorGene) genes.get(currentGene)).getActions().get(0);
	}

	public int getCurrentDuration() {
		return ((BehaviorGene) genes.get(currentGene)).getDuration();
	}
	...
	public float getCurrentSpeed() {
		return ((BehaviorGene) genes.get(currentGene)).getSpeed();
	}
